...
import {retreiveNonAuthTheme} from '../../util';

const ThemeToggler = () => {
    const {user, updateUser, nonAuthTheme, setNonAuthTheme} = useContext(UserContext) as IUserContext;
    ...
    return (
        <Flex alignItems="center">
            <Switch
                ...
                colorScheme="purple"
            />
            <Box ml="0.5rem" fontSize="1.5rem" color={user.theme === 'dark' || nonAuthTheme === 'dark' ? 'light.primary' : 'primary.dark'}>

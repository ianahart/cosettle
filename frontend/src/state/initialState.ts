...
export const spaceTypesState = [
  { name: 'All', value: 'All', id: 0 },
  { name: 'Work Space', value: 'work_space', id: 1 },
  { name: 'Chill Zone', value: 'chill_zone', id: 2 },
  { name: 'Restaurant', value: 'restaurant', id: 3 },
  { name: 'Coffee Shop', value: 'coffee_shop', id: 4 },
];

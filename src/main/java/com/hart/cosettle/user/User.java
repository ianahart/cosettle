...
public class User implements UserDetails {
    ...
    // result = prime * result + ((abbreviation == null) ? 0 :
    // abbreviation.hashCode());
    // result = prime * result + ((profile == null) ? 0 : profile.hashCode());
    // result = prime * result + ((theme == null) ? 0 : theme.hashCode());
    // result = prime * result + ((tokens == null) ? 0 : tokens.hashCode());
    // result = prime * result + ((refreshTokens == null) ? 0 :
    // refreshTokens.hashCode());
    // result = prime * result + ((passwordResets == null) ? 0 :
    // passwordResets.hashCode());
    ...
    // result = prime * result + ((adminGroups == null) ? 0 :
    // adminGroups.hashCode());
    ...
    // result = prime * result + ((groupMessages == null) ? 0 :

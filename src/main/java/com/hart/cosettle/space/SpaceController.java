...
import com.hart.cosettle.space.response.GetSpaceResponse;
...
public class SpaceController {
    ...
    @GetMapping("/{id}")
    public ResponseEntity<GetSpaceResponse> getSpace(@PathVariable("id") Long id) {
        return ResponseEntity.status(HttpStatus.OK)
                .body(new GetSpaceResponse("success", this.spaceService.getSpace(id)));
    }
